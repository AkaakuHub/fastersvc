...
class AudioPreprocessingTest(unittest.TestCase):
    ...
    def test_perceptual_loudness_has_decoder_frame_timing(self):
        ...
        silence_loudness = torch.log(torch.tensor(1e-5))
        self.assertTrue(torch.allclose(loudness, torch.full_like(loudness, silence_loudness)))
    ...
    def test_perceptual_loudness_applies_a_weighting(self):
        ...
        self.assertGreater((reference_loudness - low_loudness).item(), 2.0)
